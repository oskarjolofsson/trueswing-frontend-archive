                ...
                <button
                  ...
                  className={`flex-1 py-3 px-4 rounded-lg font-medium transition-all duration-200 ${
                    selectedRating === btn.id
                      ? `bg-${btn.color}-500 text-white shadow-lg scale-105`
            ...
            >
              <div className="mt-4 pt-4 border-t border-slate-700 space-y-3">
                ...
                <textarea
                  ...
                  className="w-full bg-slate-700 text-white placeholder-gray-400 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none min-h-24"
                />
