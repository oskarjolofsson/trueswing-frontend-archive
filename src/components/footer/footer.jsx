    ...
    <footer className="bg-[#0b1020] text-slate-300 border-t border-white/10">
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto max-w-6xl px-4 py-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-400">
          <p>
            Shipped with <span className="text-red-500">❤</span> from 🇸🇪 • © 2025 YourBrand
          </p>
          <div className="flex items-center gap-4 text-slate-400">
            ...
            <a href="#" className="hover:text-white">
              <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24"><path d="M24 4.56a9.86 9.86 0 0 1-2.828.775A4.932 4.932 0 0 0 23.337 3a9.868 9.868 0 0 1-3.127 1.195 4.92 4.92 0 0 0-8.385 4.482A13.978 13.978 0 0 1 1.671 3.149a4.922 4.922 0 0 0 1.523 6.573A4.903 4.903 0 0 1 .96 9.1v.062a4.923 4.923 0 0 0 3.946 4.827 4.935 4.935 0 0 1-2.212.084 4.928 4.928 0 0 0 4.6 3.417A9.868 9.868 0 0 1 0 19.54a13.94 13.94 0 0 0 7.548 2.213c9.057 0 14.01-7.496 14.01-13.986 0-.213-.004-.425-.014-.637A10.012 10.012 0 0 0 24 4.56z"/></svg>
            </a>
          </div>
        </div>
      </div>
