  ...
  return (
    ...
    >
      ...
      >
        ...
        {!isMinimized && (
          <div className="flex items-center gap-3 bg-slate-800 rounded-full px-4 py-1 shadow-lg border border-slate-700 animate-in fade-in slide-in-from-bottom-2 duration-300">
            <div className="flex-1">
              <p className="text-sm font-medium text-white whitespace-nowrap">
                Help shape True Swing
              </p>
            </div>
            <button
