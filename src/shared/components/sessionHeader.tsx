...
export default function SessionHeader({ onShareClick, showShare, onDeleteClick } : { onShareClick: () => void, showShare: boolean, onDeleteClick?: () => void}) {
        ...
        <div className="h-16 border-b border-l border-white/10 rounded-l-xl flex items-center justify-between px-6 w-full ml-2">
            ...
            {onDeleteClick && (
                <button 
                    ...
                    className="flex items-center gap-2 border-red-600 hover:bg-slate-700 text-white px-4 py-2 rounded-lg transition-colors duration-200 ml-8"
                >
